...
<Callout>
	Note: After installation, the connection to the Slush wallet web app will only show if the user
	does *not* have the Slush wallet extension installed in their browser.
</Callout>
