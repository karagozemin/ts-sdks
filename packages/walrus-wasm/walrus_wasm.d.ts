...
export class BlobEncoder {
   ...
   */
  encode_with_metadata(data: Uint8Array, encoding_type: any): any;
  /**
   ...
   */
  compute_metadata(data: Uint8Array, encoding_type: any): any;
  /**
   ...
   * Returns `Vec<u8>`.
   */
  decode_primary(blob_id: any, blob_size: bigint, slivers: any, encoding_type: any): any;
}
