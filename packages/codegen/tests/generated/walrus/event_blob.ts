...
export function init(packageAddress: string) {
    ...
    return { new_attestation, last_attested_event_blob_checkpoint_seq_num, last_attested_event_blob_epoch, new_event_blob, blob_id, ending_checkpoint_sequence_number, create_with_empty_state, get_latest_certified_blob_id, get_latest_certified_checkpoint_sequence_number, is_blob_already_certified, update_latest_certified_event_blob, update_aggregate_weight, start_tracking_blob, stop_tracking_blob, reset };
}