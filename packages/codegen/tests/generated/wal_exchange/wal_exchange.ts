...
export function init(packageAddress: string) {
    ...
    return { new_exchange_rate, wal_to_sui, sui_to_wal, new: , new_funded, add_wal, add_sui, add_all_wal, add_all_sui, check_admin, withdraw_wal, withdraw_sui, set_exchange_rate, exchange_all_for_wal, exchange_for_wal, exchange_all_for_sui, exchange_for_sui };
}