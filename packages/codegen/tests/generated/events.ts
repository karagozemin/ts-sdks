...
export function init(packageAddress: string) {
    ...
    return { emit_blob_registered, emit_blob_certified, emit_invalid_blob_id, emit_blob_deleted, emit_epoch_change_start, emit_epoch_change_done, emit_shards_received, emit_epoch_parameters_selected, emit_shard_recovery_start, emit_contract_upgraded, emit_register_deny_list_update, emit_deny_list_update, emit_deny_listed_blob_deleted, emit_contract_upgrade_proposed, emit_contract_upgrade_quorum_reached };
}