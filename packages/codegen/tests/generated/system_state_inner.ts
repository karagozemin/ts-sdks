...
export function init(packageAddress: string) {
    ...
    return { create_empty, advance_epoch, reserve_space, reserve_space_without_payment, invalidate_blob_id, register_blob, certify_blob, delete_blob, extend_blob_with_resource, extend_blob, process_storage_payments, certify_event_blob, add_subsidy, epoch, total_capacity_size, used_capacity_size, committee, n_shards, write_price, register_deny_list_update, update_deny_list, delete_deny_listed_blob };
}