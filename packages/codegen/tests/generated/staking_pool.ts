...
export function init(packageAddress: string) {
    ...
    return { _new, set_withdrawing, stake, request_withdraw_stake, withdraw_stake, advance_epoch, process_pending_stake, set_next_commission, set_next_storage_price, set_next_write_price, set_next_node_capacity, set_next_public_key, set_name, set_network_address, set_network_public_key, set_node_metadata, destroy_empty, exchange_rate_at_epoch, wal_balance_at_epoch, governance_authorized, set_governance_authorized, commission_receiver, set_commission_receiver, commission_rate, commission_amount, collect_commission, rewards_amount, wal_balance, storage_price, write_price, node_capacity, activation_epoch, node_info, is_active, is_withdrawing, is_empty, calculate_rewards };
}