...
export function init(packageAddress: string) {
    function new_bls_committee(options: {
        ...
        const argumentsTypes = [
            "u32",
            `vector<${packageAddress}::bls_aggregate::BlsCommitteeMember>`
        ];
    ...
    function node_id(options: {
        ...
        const argumentsTypes = [
            `${packageAddress}::bls_aggregate::BlsCommitteeMember`
        ];
        return (tx: Transaction) => tx.moveCall({
            package: packageAddress,
            module: "bls_aggregate",
    ...
    return { new_bls_committee, new_bls_committee_member, node_id, epoch, n_shards, n_members, get_idx, contains, get_member_weight, find_index, to_vec_map, verify_quorum_in_epoch, is_quorum, verify_one_correct_node_in_epoch, includes_one_correct_node, verify_certificate_and_weight };
}