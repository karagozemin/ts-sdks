...
export function init(packageAddress: string) {
    ...
    return { _new, new_with_initial_rates_and_funds, add_funds, check_admin, check_version_upgrade, set_buyer_subsidy_rate, set_system_subsidy_rate, apply_subsidies, extend_blob, reserve_space, migrate, admin_cap_subsidies_id, subsidy_pool_value, buyer_subsidy_rate, system_subsidy_rate };
}