...
export function init(packageAddress: string) {
    ...
    function to_bcs(options: {
        ...
        const argumentsTypes = [
            `${packageAddress}::messages::ProofOfPossessionMessage`
        ];
        return (tx: Transaction) => tx.moveCall({
            package: packageAddress,
            module: "messages",
    ...
    function certify_blob_message(options: {
        ...
        const argumentsTypes = [
            `${packageAddress}::messages::CertifiedMessage`
        ];
        return (tx: Transaction) => tx.moveCall({
            package: packageAddress,
            module: "messages",
    ...
    function invalid_blob_id(options: {
        ...
        const argumentsTypes = [
            `${packageAddress}::messages::CertifiedInvalidBlobId`
        ];
        return (tx: Transaction) => tx.moveCall({
            package: packageAddress,
            module: "messages",
    ...
    function storage_node_id(options: {
        ...
        const argumentsTypes = [
            `${packageAddress}::messages::DenyListUpdateMessage`
        ];
        return (tx: Transaction) => tx.moveCall({
            package: packageAddress,
            module: "messages",
    ...
    function blob_id(options: {
        ...
        const argumentsTypes = [
            `${packageAddress}::messages::DenyListBlobDeleted`
        ];
        return (tx: Transaction) => tx.moveCall({
            package: packageAddress,
            module: "messages",
    ...
    function is_deletable(options: {
        ...
        const argumentsTypes = [
            `${packageAddress}::messages::BlobPersistenceType`
        ];
        return (tx: Transaction) => tx.moveCall({
            package: packageAddress,
            module: "messages",
    ...
    return { new_proof_of_possession_msg, to_bcs, verify_proof_of_possession, new_certified_message, certify_blob_message, certified_event_blob_message, invalid_blob_id_message, deny_list_update_message, deny_list_blob_deleted_message, intent_type, intent_version, cert_epoch, stake_support, message, into_message, certified_blob_id, blob_persistence_type, invalid_blob_id, storage_node_id, sequence_number, size, root, blob_id, is_deletable, object_id, peel_blob_persistence_type };
}