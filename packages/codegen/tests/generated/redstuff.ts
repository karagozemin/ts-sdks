...
export function init(packageAddress: string) {
    ...
    return { encoded_blob_length, source_symbols_primary, source_symbols_secondary, n_source_symbols, symbol_size, metadata_size, decoding_safety_limit, max_byzantine };
}