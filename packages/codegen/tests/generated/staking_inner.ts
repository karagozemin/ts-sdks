...
export function init(packageAddress: string) {
    ...
    function calculate_votes(options: {
        arguments: [
            RawTransactionArgument<string>
        ];
    }) {
    ...
    function select_committee(options: {
        arguments: [
            RawTransactionArgument<string>
        ];
    }) {
    ...
    return { _new, create_pool, withdraw_node, set_commission_receiver, collect_commission, voting_end, calculate_votes, quorum_above, quorum_below, take_threshold_value, set_governance_authorized, check_governance_authorization, get_current_node_weight, set_next_commission, set_storage_price_vote, set_write_price_vote, set_node_capacity_vote, set_next_public_key, set_name, set_network_address, set_network_public_key, set_node_metadata, set_withdrawing, destroy_empty_pool, stake_with_pool, request_withdraw_stake, withdraw_stake, compute_next_committee, select_committee, apportionment, dhondt, max_shards_per_node, initiate_epoch_change, advance_epoch, epoch_sync_done, shard_transfer_failed, node_metadata, next_committee, next_epoch_params, epoch, committee, previous_committee, next_bls_committee, has_pool, n_shards, calculate_rewards, new_walrus_context, is_quorum };
}