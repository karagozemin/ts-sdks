...
export function init(packageAddress: string) {
    ...
    return { _new, create_pool, set_commission_receiver, collect_commission, voting_end, select_committee_and_calculate_votes, quorum_above, quorum_below, set_governance_authorized, check_governance_authorization, get_current_node_weight, set_next_commission, set_storage_price_vote, set_write_price_vote, set_node_capacity_vote, set_next_public_key, set_name, set_network_address, set_network_public_key, set_node_metadata, destroy_empty_pool, stake_with_pool, request_withdraw_stake, withdraw_stake, try_join_active_set, compute_next_committee, apportionment, dhondt, max_shards_per_node, initiate_epoch_change, advance_epoch, epoch_sync_done, node_metadata, next_committee, next_epoch_params, epoch, committee, previous_committee, next_bls_committee, has_pool, n_shards, calculate_rewards, new_walrus_context, is_quorum, is_quorum_for_n_shards };
}