...
export type EnokiProviderWalletInfo<T extends string> = {
	provider: T;
	name: string;
	icon: Wallet['icon'];
...
export const ENOKI_PROVIDER_WALLETS_INFO: EnokiProviderWalletInfo<AuthProvider>[] = [
	{
		provider: 'google',
	...
	},
	{
		...
		authenticationUrl: 'https://www.facebook.com/v17.0/dialog/oauth',
	},
	{
		provider: 'twitch',
		...
		authenticationUrl: 'https://id.twitch.tv/oauth2/authorize',
		extraParams: {
			force_verify: 'true',
		},
	},
